...
Commonly used version of Kempston joystick interface, similar to [KAY](https://github.com/konkotgit/KAY-Kempston-AY) with on/off jumper to disable it in case you connect other extension with joystick interface. Operation can be tested using IN 31 command.
